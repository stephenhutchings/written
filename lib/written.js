...
(function(root, factory) {
  ...
  var camelCase, capitalize, capitalizeAll, caseSplitter, cleanJoin, collapse, dictionary, enclose, fromTo, glyph, glyphs, humanCase, hyphenCase, hyphenate, ordinal, parseNumber, prettyList, prettyNumber, prettyPrice, quantify, quote, setLanguage, snakeCase, wrapInTag, written, writtenNumber;
  dictionary = {
    EN: {
